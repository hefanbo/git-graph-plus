...
export class MainPanel {
  ...
  private readModalDefaults(): ModalDefaults {
    ...
    return {
      ...
      merge: { mode: g('merge.mode', 'default'), pushAfter: g('merge.pushAfter', false), deleteSource: g('merge.deleteSource', false), strategyOurs: g('merge.strategyOurs', false), noCommit: g('merge.noCommit', false) },
  ...
  private async handleMessage(message: WebviewMessage): Promise<void> {
    try {
      switch (message.type) {
        ...
        case 'merge': {
          await this.gitService.merge(message.payload.branch, { noFf: message.payload.noFf, ffOnly: message.payload.ffOnly, squash: message.payload.squash, strategyOurs: message.payload.strategyOurs, noCommit: message.payload.noCommit });
